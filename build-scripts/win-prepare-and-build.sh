...
dnf -y install mingw64-openssl-static mingw64-gcc-c++ zstd cyrus-sasl-devel perl mingw64-libepoxy mingw64-libxml2-static mingw64-libxml++ mingw64-libxml2
# https://repo.msys2.org/mingw/mingw64/mingw-w64-x86_64-gtksourceview5-5.16.0-3-any.pkg.tar.zst
curl --connect-timeout 60 -m 60 -L -o /tmp/gtksourceview-5.pkg.tar.zst https://repo.msys2.org/mingw/mingw64/mingw-w64-x86_64-gtksourceview5-5.16.0-3-any.pkg.tar.zst
...
curl --connect-timeout 60 -m 60 -L -o /tmp/libxml2.pkg.tar.zst https://repo.msys2.org/mingw/mingw64/mingw-w64-x86_64-libxml2-2.14.6-1-any.pkg.tar.zst
# https://repo.msys2.org/mingw/mingw64/mingw-w64-x86_64-libepoxy-1.5.10-7-any.pkg.tar.zst
curl --connect-timeout 60 -m 60 -L -o /tmp/libepoxy.pkg.tar.zst https://repo.msys2.org/mingw/mingw64/mingw-w64-x86_64-libepoxy-1.5.10-7-any.pkg.tar.zst
cd /tmp
...
tar --use-compress-program=unzstd -xvf libxml2.pkg.tar.zst
tar --use-compress-program=unzstd -xvf libepoxy.pkg.tar.zst
...
# libxml2
cp -fvr /tmp/mingw64/** /usr/x86_64-w64-mingw32/sys-root/mingw/
